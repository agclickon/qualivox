...
function buildSystemPrompt(
  ...
  if (!calendarEnabled) {
    ...
    calendarInstruction = `Se o lead solicitar agendamento de reunião, consulta ou compromisso com data e hora específicas, preencha "calendarEvent" com {"title": "<título>", "startTime": "<ISO 8601>", "endTime": "<ISO 8601>", "description": "<descrição opcional>", "addMeetLink": true}. Use a data e hora mencionadas. Se o lead não especificar duração, assuma 30 minutos. Caso contrário, defina como null.${busyInfo}\n${cancelRescheduleInstruction}`
  }
