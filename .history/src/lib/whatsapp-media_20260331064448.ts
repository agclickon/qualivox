...
type ExtractedMedia =
  | { kind: "image"; payload: proto.IImageMessage }
  | { kind: "video"; payload: proto.IVideoMessage }
  | { kind: "audio"; payload: proto.IAudioMessage }
  | { kind: "document"; payload: proto.IDocumentMessage }
  | { kind: "sticker"; payload: proto.IStickerMessage }
