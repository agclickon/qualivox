...
export function Sidebar({ mobileOpen, onClose }: SidebarProps) {
  ...
  const sidebarContent = (
    <>
      ...
      <div className="flex h-16 items-center justify-between border-b px-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-foreground/80">Versão {APP_VERSION}</p>
          </div>
        </div>
        {onClose && (
      ...
      <div className="border-t p-3 space-y-2">
        ...
        <div className="rounded-lg bg-muted/40 px-3 py-2 text-[10px] uppercase tracking-wide text-muted-foreground">
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside
        className="fixed left-0 top-0 z-40 hidden md:flex h-screen flex-col border-r bg-card"
