...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen">
      ...
      />
      <div className="flex flex-1 flex-col md:ml-[var(--sidebar-current-width)]" style={contentStyle}>
        <Header onToggleSidebar={() => setMobileOpen(!mobileOpen)} />
        <main className="flex-1 pt-4 pb-6 pr-4 md:pr-6 md:pt-6" style={{ marginTop: "var(--header-height)" }}>
          <Breadcrumbs />
          {children}
        </main>
      </div>
