                ...
                stage.leads.map((lead) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1.5 flex-wrap mt-2 ml-6">
                        <span className={`inline-flex items-center gap-0.5 rounded-full border px-1.5 py-0.5 text-[10px] font-medium ${qual.color}`}>
                          {qual.icon === "Star" ? <Flame className="h-2 w-2" /> : qual.icon === "Thermometer" ? <Snowflake className="h-2 w-2" /> : qual.icon} {qual.label}
                        </span>
                        {lead.lifecycleStage && lead.lifecycleStage !== "prospect" && (
                          <LifecycleBadge stage={lead.lifecycleStage} />
                        )}
                      ...
                      {lead.tags.length > 0 && (
                        <div className="flex flex-wrap gap-1 mt-2 ml-6">
                          ...
                          {lead.tags.length > 3 && (
                            <span className="rounded-full bg-muted px-2 py-0.5 text-[10px] text-muted-foreground border border-border">+{lead.tags.length - 3}</span>
                          )}
                        </div>
                      )}
                    </CardContent>
