...
function LeadAvatar({ lead, size = "md" }: { lead: KanbanLead; size?: "sm" | "md" | "lg" }) {
  ...
  return (
    <div className={`${cls} rounded-full bg-primary/15 flex items-center justify-center font-bold text-primary flex-shrink-0 border-2 border-primary/40 ring-2 ring-primary/10`}>
