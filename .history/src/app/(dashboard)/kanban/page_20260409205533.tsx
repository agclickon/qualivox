                  ...
                  return (
                    ...
                    >
                      <CardContent className="p-3">
                        ...
                        {(() => {
                          const sentiment = lead.realtimeSentiment ?? "neutro"
                          const sentimentLabel = sentiment === "positivo" ? "Sentimento positivo" : sentiment === "negativo" ? "Sentimento negativo" : "Sentimento neutro"
                          ...
                          return (
                            <div className="flex items-center justify-between mt-2 ml-6">
                              <div className="flex items-center gap-1.5">
                                ...
                                {sentiment === "negativo" && (lead.realtimeUrgency ?? 0) >= 70 && (
