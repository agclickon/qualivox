...
export async function GET(req: NextRequest) {
  try {
    ...
    const extraFields = await prisma.$queryRaw<{
      ...
      SELECT id, avatar_url, voice_enabled, voice_mode, voice_id, voice_speed, voice_stability, voice_similarity, typing_delay, typing_delay_max, mark_as_read, split_messages FROM agents
    `
