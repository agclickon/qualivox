...
export async function scheduleEventReminders(params: ScheduleRemindersParams): Promise<void> {
...
export async function cancelEventReminders(googleEventId: string): Promise<void> {
  await ensureReminderTable()
  await prisma.$executeRawUnsafe(
