...
export default function PerfilPage() {
  ...
  const onUpdateProfile = async (data: UpdateProfileInput) => {
    try {
      ...
      toast({ variant: "destructive", title: "Erro", description: error instanceof Error ? error.message : "Não foi possível atualizar o perfil." })
    } finally {
      setIsUpdating(false)
    }
  }

  const onChangePassword = async (formData: ChangePasswordInput) => {
    try {
      ...
      toast({ variant: "destructive", title: "Erro", description: error instanceof Error ? error.message : "Não foi possível alterar a senha." })
    } finally {
